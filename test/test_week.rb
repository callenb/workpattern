...
class TestWeek < MiniTest::Test #:nodoc:
  ...
  def test_must_create_a_working_week
    ...
    assert_equal Time.gm(start.year,start.month,start.day), working_week.start
    assert_equal Time.gm(finish.year,finish.month,finish.day), working_week.finish
  ...
  def test_must_create_a_resting_week
    ...
    assert_equal Time.gm(start.year,start.month,start.day), resting_week.start
    assert_equal Time.gm(finish.year,finish.month,finish.day), resting_week.finish
  ...
  def test_must_duplicate_all_of_a_week
    ...
    assert_equal Time.gm(start.year,start.month,start.day), new_week.start
    assert_equal Time.gm(finish.year,finish.month,finish.day), new_week.finish
  ...
  def test_must_add_minutes_in_a_working_week_result_in_same_day
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,3,7,31),29)
    assert_equal Time.gm(2000,1,3,8,0), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_minutes_in_a_working_week_result_in_next_day
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,3,7,31),990)
    assert_equal Time.gm(2000,1,4,0,1), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_minutes_in_a_working_week_result_in_later_day
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,3,7,31),2430)
    assert_equal Time.gm(2000,1,5,0,1), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_minutes_in_a_working_week_result_in_start_next_day
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,3,7,31),989)
    assert_equal Time.gm(2000,1,4,0,0), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_0_minutes_in_a_working_week
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,3,7,31),0)
    assert_equal Time.gm(2000,1,3,7,31), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_too_many_minutes_in_a_working_week
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,3,7,31),9630)
    assert_equal Time.gm(2000,1,10,0,0), result_date
    refute midnight_flag
    assert_equal 1, result_duration
  end

  def test_must_add_minutes_in_a_resting_week
    result_date, result_duration, midnight_flag = @resting_week.calc(Time.gm(2000,1,3,7,31),29)
    assert_equal Time.gm(2000,1,10,0,0), result_date
    refute midnight_flag
  ...
  def test_must_add_minutes_from_start_of_resting_week
    result_date, result_duration, midnight_flag = @resting_week.calc(Time.gm(2000,1,3,0,0),990)
    assert_equal Time.gm(2000,1,10,0,0), result_date
    refute midnight_flag
  ...
  def test_must_add_minutes_to_last_minute_of_a_resting_week
    result_date, result_duration, midnight_flag = @resting_week.calc(Time.gm(2000,1,9,23,59),2430)
    assert_equal Time.gm(2000,1,10,0,0), result_date
    refute midnight_flag
  ...
  def test_must_add_zero_minutes_in_a_resting_week
    result_date, result_duration, midnight_flag = @resting_week.calc(Time.gm(2000,1,3,7,31),0)
    assert_equal Time.gm(2000,1,3,7,31), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end
  ...
  def test_must_add_minutes_from_working_in_a_pattern_week_result_in_same_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,3,10,11),110)
    assert_equal Time.gm(2000,1,3,12,1), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_minutes_from_resting_in_a_pattern_week_result_in_same_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,3,12,45),126)
    assert_equal Time.gm(2000,1,3,15,7), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_minutes_from_working_in_a_pattern_week_result_in_next_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,3,10,11),379)
    assert_equal Time.gm(2000,1,4,9,1), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_minutes_from_resting_in_a_pattern_week_result_in_next_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,3,12,45),240)
    assert_equal Time.gm(2000,1,4,9,1), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end
  ...
  def test_must_add_minutes_from_working_in_a_pattern_week_result_in_later_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,3,10,11),828)
    assert_equal Time.gm(2000,1,5,9,1), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_minutes_from_resting_in_a_working_week_result_in_later_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,3,12,45),689)
    assert_equal Time.gm(2000,1,5,9,1), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end
  ...
  def test_must_add_0_minutes_from_working_in_a_resting_week
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,3,10,11),0)
    assert_equal Time.gm(2000,1,3,10,11), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_0_minutes_from_resting_in_a_resting_week
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,3,12,45),0)
    assert_equal Time.gm(2000,1,3,12,45), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_add_too_many_minutes_in_a_pattern__week
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,3,10,11),2175)
    assert_equal Time.gm(2000,1,10,0,0), result_date
    refute midnight_flag
    assert_equal 1, result_duration
  end
  ...
  def test_must_subtract_minutes_in_a_working_week_result_in_same_day
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,8,7,31),-29)
    assert_equal Time.gm(2000,1,8,7,2), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_in_a_working_week_result_in_previous_day
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,8,7,31),-452)
    assert_equal Time.gm(2000,1,7,23,59), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_in_a_working_week_result_in_earlier_day
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,8,7,31),-1892)
    assert_equal Time.gm(2000,1,6,23,59), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_in_a_working_week_result_at_start_of_day
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,8,7,31),-451)
    assert_equal Time.gm(2000,1,8,0,0), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_in_a_working_week_result_at_start_of_previous_day
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,8,7,31),-1891)
    assert_equal Time.gm(2000,1,7,0,0), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_too_many_minutes_from_a_working_week
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,8,7,31),-7652)
    assert_equal Time.gm(2000,1,2,0,0), result_date
    assert midnight_flag
    assert_equal -1, result_duration
  end

  def test_must_subtract_1_minute_from_start_of_next_day_after_working_week
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,9,0,0),-1,true)
    assert_equal Time.gm(2000,1,9,23,59), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_2_minutes_from_start_of_next_day_after_working_week
    result_date, result_duration, midnight_flag = @working_week.calc(Time.gm(2000,1,9,0,0),-2,true)
    assert_equal Time.gm(2000,1,9,23,58), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_from_last_day_in_a_resting_week
    result_date, result_duration, midnight_flag = @resting_week.calc(Time.gm(2000,1,10,7,31),-29)
    assert_equal Time.gm(2000,1,2,0,0), result_date
    assert midnight_flag
    assert_equal -29, result_duration
  end
  ...
  def test_must_subtract_minutes_from_middle_day_in_a_resting_week
    result_date, result_duration, midnight_flag = @resting_week.calc(Time.gm(2000,1,8,7,31),-452)
    assert_equal Time.gm(2000,1,2,0,0), result_date
    assert midnight_flag
  ...
  def test_must_subtract_minutes_from_start_of_resting_week
    result_date, result_duration, midnight_flag = @resting_week.calc(Time.gm(2000,1,3,0,0),-1892)
    assert_equal Time.gm(2000,1,2,0,0), result_date
    assert midnight_flag
  ...
  def test_must_subtract_minutes_from_start_of_next_day_after_resting_week
    result_date, result_duration, midnight_flag = @resting_week.calc(Time.gm(2000,1,9,0,0),-1,true)
    assert_equal Time.gm(2000,1,2,0,0), result_date
    assert midnight_flag
    assert_equal -1, result_duration
  end
  ...
  def test_must_subtract_minutes_from_resting_day_in_a_pattern_week
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,8,13,29),-29)
    assert_equal Time.gm(2000,1,7,16,31), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_from_working_day_in_a_pattern_week
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,7,13,29),-29)
    assert_equal Time.gm(2000,1,7,12,29), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_in_a_pattern_week_result_in_previous_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,7,9,1),-2)
    assert_equal Time.gm(2000,1,6,16,59), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_in_a_pattern_week_result_in_earlier_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,7,13,29),-240)
    assert_equal Time.gm(2000,1,6,16,58), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_in_a_pattern_week_result_at_start_of_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,7,13,29),-238)
    assert_equal Time.gm(2000,1,7,9,0), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_minutes_in_a_pattern_week_result_at_start_of_previous_day
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,7,13,29),-687)
    assert_equal Time.gm(2000,1,6,9,0), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_too_many_minutes_from_a_pattern_week
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,7,9,0),-1797)
    assert_equal Time.gm(2000,1,2,0,0), result_date
    assert midnight_flag
    assert_equal -1, result_duration
  end
  ...
  def test_must_subtract_1_minute_from_start_of_next_day_after_pattern_week
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,9,0,0),-1,true)
    assert_equal Time.gm(2000,1,7,16,59), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end

  def test_must_subtract_2_minutes_from_start_of_next_day_after_pattern_week
    result_date, result_duration, midnight_flag = @pattern_week.calc(Time.gm(2000,1,9,0,0),-2,true)
    assert_equal Time.gm(2000,1,7,16,58), result_date
    refute midnight_flag
    assert_equal 0, result_duration
  end
...
### @pattern_week centric
  ...
  def must_diff_day_week_day_in_patterned_week
    ...
    duration, start =working_week.diff(Time.gm(2013,10,3,16,0),Time.gm(2013,10,15,12,30))
  ...
  def test_must_diff_from_last_day_of_patterned_week
    ...
    duration, start =working_week.diff(Time.gm(2013,9,26,17,0),Time.gm(2013,9,27,10,0))
  ...
  def test_must_diff_long_distances_beyond_end_of_patterned_week
    ...
    duration, start =working_week.diff(Time.gm(2013,9,26,17,0),Time.gm(2018,9,27,10,0))
  ...
  def test_must_diff_long_distances_within_patterned_week
    ...
    duration, start =working_week.diff(Time.gm(2013,9,26,17,0),Time.gm(2013,10,15,10,0))
