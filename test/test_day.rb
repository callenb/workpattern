...
class TestDay < Test::Unit::TestCase #:nodoc:
  ...
  must 'subtract minutes in a patterned day' do
    ...
    tests=[
     ...
     [2000,1,1,9,30,-60,2000,1,1,0,0,-30],
     [2000,12,31,22,59,-1,2000,12,31,16,59,0],
     [2000,1,1,9,10,-33,2000,1,1,0,0,-23],
     [2000,1,1,9,10,-60,2000,1,1,0,0,-50],
     [2000,1,1,9,1,-931,2000,1,1,0,0,-930],
     [2000,1,1,12,0,-1,2000,1,1,11,59,0],
     [2000,1,1,12,59,-1,2000,1,1,11,59,0]
    ]
